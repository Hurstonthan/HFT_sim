...
VL_ATTR_COLD void Vether_simulation_TCP__F10_CBz2___eval_initial__TOP__ether_simulation__clt_inst__u_tcp(Vether_simulation_TCP__F10_CBz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_TCP__F10_CBz2___eval_initial__TOP__ether_simulation__clt_inst__u_tcp\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSymsp->TOP__ether_simulation__clt_inst__u_tcp__ISN_gen.__PVT__gen_en = 0U;
    vlSymsp->TOP__ether_simulation__clt_inst__u_tcp__timeout_fl.__PVT__initial_val = 0U;
    vlSymsp->TOP__ether_simulation__clt_inst__u_tcp__timeout_fl.__PVT__rollover_val = 0x1194U;
    vlSymsp->TOP__ether_simulation__clt_inst__u_tcp__inst.__PVT__clear = 0U;
}
...
VL_ATTR_COLD void Vether_simulation_TCP__F10_CBz2___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__0(Vether_simulation_TCP__F10_CBz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_TCP__F10_CBz2___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vether_simulation_TCP__F10_CBz2___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__1(Vether_simulation_TCP__F10_CBz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_TCP__F10_CBz2___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vether_simulation_TCP__F10_CBz2___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__2(Vether_simulation_TCP__F10_CBz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_TCP__F10_CBz2___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__2\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vether_simulation_TCP__F10_CBz2___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__3(Vether_simulation_TCP__F10_CBz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_TCP__F10_CBz2___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__3\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
