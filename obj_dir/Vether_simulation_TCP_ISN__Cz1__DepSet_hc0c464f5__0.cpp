...
VL_INLINE_OPT void Vether_simulation_TCP_ISN__Cz1___nba_sequent__TOP__ether_simulation__svr_inst__u_tcp__ISN_gen__0(Vether_simulation_TCP_ISN__Cz1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_ISN__Cz1___nba_sequent__TOP__ether_simulation__svr_inst__u_tcp__ISN_gen__0\n"); );
    ...
    if (vlSelfRef.__PVT__nRST) {
        ...
        vlSelfRef.__Vdly__ISN_num = 0x123abcdeU;
    }
