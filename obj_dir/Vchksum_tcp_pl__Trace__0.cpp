...
void Vchksum_tcp_pl___024root__trace_chg_0_sub_0(Vchksum_tcp_pl___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+2,(vlSelfRef.FIFO_rd_en));
    bufp->chgBit(oldp+3,(vlSelfRef.clear));
    bufp->chgQData(oldp+4,(vlSelfRef.TCP_payload_tx),64);
    bufp->chgSData(oldp+6,(vlSelfRef.TCP_checksum_pl),16);
    bufp->chgIData(oldp+7,(vlSelfRef.chksum_tcp_pl__DOT__TCP_checksum),17);
    bufp->chgIData(oldp+8,(vlSelfRef.chksum_tcp_pl__DOT__nTCP_checksum),17);
    bufp->chgIData(oldp+9,(vlSelfRef.chksum_tcp_pl__DOT__temp),20);
}
