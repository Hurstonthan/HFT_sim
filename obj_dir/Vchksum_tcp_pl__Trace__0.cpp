...
void Vchksum_tcp_pl___024root__trace_chg_0_sub_0(Vchksum_tcp_pl___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        bufp->chgBit(oldp+0,(vlSymsp->TOP__chksum_tcp_pl.CLK));
        bufp->chgBit(oldp+1,(vlSymsp->TOP__chksum_tcp_pl.nRST));
        bufp->chgBit(oldp+2,(vlSymsp->TOP__chksum_tcp_pl.FIFO_rd_en));
        bufp->chgBit(oldp+3,(vlSymsp->TOP__chksum_tcp_pl.clear));
        bufp->chgQData(oldp+4,(vlSymsp->TOP__chksum_tcp_pl.TCP_payload_tx),64);
    }
    bufp->chgBit(oldp+6,(vlSelfRef.CLK));
    bufp->chgBit(oldp+7,(vlSelfRef.nRST));
    bufp->chgBit(oldp+8,(vlSelfRef.FIFO_rd_en));
    bufp->chgBit(oldp+9,(vlSelfRef.clear));
    bufp->chgQData(oldp+10,(vlSelfRef.TCP_payload_tx),64);
    bufp->chgSData(oldp+12,(vlSelfRef.TCP_checksum_pl),16);
    bufp->chgSData(oldp+13,(vlSymsp->TOP__chksum_tcp_pl.TCP_checksum_pl),16);
    bufp->chgIData(oldp+14,(vlSymsp->TOP__chksum_tcp_pl.__PVT__TCP_checksum),17);
    bufp->chgIData(oldp+15,(vlSymsp->TOP__chksum_tcp_pl.__PVT__nTCP_checksum),17);
    bufp->chgIData(oldp+16,(vlSymsp->TOP__chksum_tcp_pl.__PVT__temp),20);
}
