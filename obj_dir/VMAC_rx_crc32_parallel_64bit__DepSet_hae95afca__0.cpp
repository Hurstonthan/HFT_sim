...
VL_INLINE_OPT void VMAC_rx_crc32_parallel_64bit___ico_sequent__TOP__MAC_rx__CRC__0(VMAC_rx_crc32_parallel_64bit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VMAC_rx_crc32_parallel_64bit___ico_sequent__TOP__MAC_rx__CRC__0\n"); );
