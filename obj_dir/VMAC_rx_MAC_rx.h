...
#ifndef VERILATED_VMAC_RX_MAC_RX_H_
#define VERILATED_VMAC_RX_MAC_RX_H_  // guard

#include "verilated.h"
class VMAC_rx_crc32_parallel_64bit;
class VMAC_rx_priority_encoder__W10_Mz1;
class VMAC_rx_priority_encoder__W8_Mz1;
class VMAC_rx_xgmii_little_to_big;


class VMAC_rx__Syms;

class alignas(VL_CACHE_LINE_BYTES) VMAC_rx_MAC_rx final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    VMAC_rx_MAC_rx(VMAC_rx__Syms* symsp, const char* v__name);
    ~VMAC_rx_MAC_rx();
    VL_UNCOPYABLE(VMAC_rx_MAC_rx);
