...
VL_INLINE_OPT void Vether_simulation_priority_encoder__W10_Mz2___ico_sequent__TOP__ether_simulation__svr_inst__mac_rx__xgmii_fcs__0(Vether_simulation_priority_encoder__W10_Mz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vether_simulation_priority_encoder__W10_Mz2___ico_sequent__TOP__ether_simulation__svr_inst__mac_rx__xgmii_fcs__0\n"); );
...
VL_INLINE_OPT void Vether_simulation_priority_encoder__W10_Mz2___nba_comb__TOP__ether_simulation__svr_inst__mac_rx__xgmii_fcs__0(Vether_simulation_priority_encoder__W10_Mz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vether_simulation_priority_encoder__W10_Mz2___nba_comb__TOP__ether_simulation__svr_inst__mac_rx__xgmii_fcs__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__valid = 0U;
...
VL_INLINE_OPT void Vether_simulation_priority_encoder__W10_Mz2___ico_sequent__TOP__ether_simulation__clt_inst__mac_rx__xgmii_fcs__0(Vether_simulation_priority_encoder__W10_Mz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vether_simulation_priority_encoder__W10_Mz2___ico_sequent__TOP__ether_simulation__clt_inst__mac_rx__xgmii_fcs__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__valid = 0U;
...
VL_INLINE_OPT void Vether_simulation_priority_encoder__W10_Mz2___nba_comb__TOP__ether_simulation__clt_inst__mac_rx__xgmii_fcs__0(Vether_simulation_priority_encoder__W10_Mz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vether_simulation_priority_encoder__W10_Mz2___nba_comb__TOP__ether_simulation__clt_inst__mac_rx__xgmii_fcs__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__valid = 0U;
