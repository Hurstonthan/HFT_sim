...
VL_ATTR_COLD void Vtop___024root___eval_stl(Vtop___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        ...
        Vtop_flex_counter__S20___stl_sequent__TOP__top__u_tcp__timeout_fl__0((&vlSymsp->TOP__top__u_tcp__timeout_fl));
        ...
        Vtop_priority_encoder__Wa___stl_sequent__TOP__top__u_tcp__tcp_flow__lt__0((&vlSymsp->TOP__top__u_tcp__tcp_flow__lt));
        Vtop_priority_encoder__Wa___stl_sequent__TOP__top__u_tcp__tcp_flow__rt__0((&vlSymsp->TOP__top__u_tcp__tcp_flow__rt));
        Vtop_priority_encoder__Wa___stl_sequent__TOP__top__u_tcp__tcp_flow__ov__0((&vlSymsp->TOP__top__u_tcp__tcp_flow__ov));
