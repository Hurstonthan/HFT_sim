...
VL_INLINE_OPT void VMAC_rx_priority_encoder__W8_Mz1___ico_sequent__TOP__MAC_rx__crc_check_encoder__0(VMAC_rx_priority_encoder__W8_Mz1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VMAC_rx_priority_encoder__W8_Mz1___ico_sequent__TOP__MAC_rx__crc_check_encoder__0\n"); );
