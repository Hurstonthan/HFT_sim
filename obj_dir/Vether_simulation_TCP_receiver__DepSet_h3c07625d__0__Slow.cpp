...
VL_ATTR_COLD void Vether_simulation_TCP_receiver___stl_sequent__TOP__ether_simulation__svr_inst__u_tcp__tcp_rcv__0(Vether_simulation_TCP_receiver* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_receiver___stl_sequent__TOP__ether_simulation__svr_inst__u_tcp__tcp_rcv__0\n"); );
...
VL_ATTR_COLD void Vether_simulation_TCP_receiver___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__tcp_rcv__0(Vether_simulation_TCP_receiver* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_receiver___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__tcp_rcv__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    IData/*31:0*/ __Vtemp_1;
...
VL_ATTR_COLD void Vether_simulation_TCP_receiver___ctor_var_reset(Vether_simulation_TCP_receiver* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_receiver___ctor_var_reset\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
