...
#ifndef VERILATED_VETHER_SIMULATION_MAC_RX_H_
#define VERILATED_VETHER_SIMULATION_MAC_RX_H_  // guard

#include "verilated.h"
class Vether_simulation_crc32_parallel_64bit;
class Vether_simulation_priority_encoder__W10_Mz1;
class Vether_simulation_priority_encoder__W8_Mz1;
class Vether_simulation_xgmii_little_to_big;


class Vether_simulation__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vether_simulation_MAC_rx final : public VerilatedModule {
  public:
    // CELLS
    Vether_simulation_crc32_parallel_64bit* __PVT__CRC;
    Vether_simulation_xgmii_little_to_big* __PVT__crc_convert;
    Vether_simulation_xgmii_little_to_big* __PVT__crc_frame_convert;
    Vether_simulation_xgmii_little_to_big* __PVT__payload_cvrt;
    Vether_simulation_xgmii_little_to_big* __PVT__xgmii_cvrt;
    Vether_simulation_priority_encoder__W8_Mz1* __PVT__crc_check_encoder;
    Vether_simulation_priority_encoder__W10_Mz1* __PVT__xgmii_fcs;
    ...
    // CONSTRUCTORS
    Vether_simulation_MAC_rx(Vether_simulation__Syms* symsp, const char* v__name);
    ~Vether_simulation_MAC_rx();
    VL_UNCOPYABLE(Vether_simulation_MAC_rx);
