...
class Vether_simulation_priority_encoder__W10_Mz2;
class Vether_simulation_priority_encoder__W8_Mz2;
...
class alignas(VL_CACHE_LINE_BYTES) Vether_simulation_MAC_rx final : public VerilatedModule {
  public:
    ...
    Vether_simulation_priority_encoder__W8_Mz2* __PVT__crc_check_encoder;
    Vether_simulation_priority_encoder__W10_Mz2* __PVT__xgmii_fcs;
