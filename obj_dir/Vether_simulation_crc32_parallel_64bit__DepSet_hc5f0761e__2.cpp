...
VL_INLINE_OPT void Vether_simulation_crc32_parallel_64bit___ico_sequent__TOP__ether_simulation__clt_inst__mac_tx__CRC__0(Vether_simulation_crc32_parallel_64bit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_crc32_parallel_64bit___ico_sequent__TOP__ether_simulation__clt_inst__mac_tx__CRC__0\n"); );
...
VL_INLINE_OPT void Vether_simulation_crc32_parallel_64bit___nba_sequent__TOP__ether_simulation__clt_inst__mac_tx__CRC__0(Vether_simulation_crc32_parallel_64bit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_crc32_parallel_64bit___nba_sequent__TOP__ether_simulation__clt_inst__mac_tx__CRC__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_INLINE_OPT void Vether_simulation_crc32_parallel_64bit___nba_comb__TOP__ether_simulation__clt_inst__mac_tx__CRC__0(Vether_simulation_crc32_parallel_64bit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_crc32_parallel_64bit___nba_comb__TOP__ether_simulation__clt_inst__mac_tx__CRC__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_ASSIGNBIT_II(0U, vlSelfRef.__PVT__next_crc, 
