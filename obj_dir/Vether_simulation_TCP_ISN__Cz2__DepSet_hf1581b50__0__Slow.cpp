...
VL_ATTR_COLD void Vether_simulation_TCP_ISN__Cz2___ctor_var_reset(Vether_simulation_TCP_ISN__Cz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_ISN__Cz2___ctor_var_reset\n"); );
