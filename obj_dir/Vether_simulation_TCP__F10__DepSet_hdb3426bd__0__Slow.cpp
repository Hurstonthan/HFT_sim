...
VL_ATTR_COLD void Vether_simulation_TCP__F10___ctor_var_reset(Vether_simulation_TCP__F10* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_TCP__F10___ctor_var_reset\n"); );
