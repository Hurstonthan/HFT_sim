...
#ifndef VERILATED_VETHER_SIMULATION_PAYLOAD_FIFO_H_
#define VERILATED_VETHER_SIMULATION_PAYLOAD_FIFO_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vether_simulation_payload_FIFO final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__handshake;
        CData/*0:0*/ __PVT__nhandshake;
        ...
        CData/*0:0*/ __Vdly__rd_FIFO_valid_l;
        CData/*3:0*/ __Vdly__rd_len_ptr;
        CData/*0:0*/ __Vdly__handshake;
        ...
        CData/*3:0*/ __VdlyDim0__TCP_FIFO__v16;
        ...
        CData/*0:0*/ __VdlySet__TCP_FIFO__v21;
        CData/*0:0*/ __VdlySet__TCP_FIFO__v22;
        CData/*0:0*/ __VdlySet__TCP_FIFO__v23;
        CData/*0:0*/ __VdlySet__TCP_FIFO__v24;
        CData/*0:0*/ __VdlySet__TCP_FIFO__v25;
        CData/*0:0*/ __VdlySet__TCP_FIFO__v26;
        CData/*0:0*/ __VdlySet__TCP_FIFO__v27;
        CData/*0:0*/ __VdlySet__TCP_FIFO__v28;
        CData/*0:0*/ __VdlySet__TCP_FIFO__v29;
        CData/*0:0*/ __VdlySet__TCP_FIFO__v30;
    };
    struct {
        CData/*0:0*/ __VdlySet__TCP_FIFO__v31;
        CData/*0:0*/ __VdlySet__TCP_FIFO__v32;
        ...
        VlUnpacked<VlWide<3>/*71:0*/, 16> __PVT__TCP_FIFO;
        VlUnpacked<VlWide<3>/*71:0*/, 16> __PVT__nTCP_FIFO;
        VlUnpacked<QData/*63:0*/, 16> __PVT__payload;
        VlUnpacked<CData/*7:0*/, 16> __PVT__bytes_offset;
    };
    ...
    // CONSTRUCTORS
    Vether_simulation_payload_FIFO(Vether_simulation__Syms* symsp, const char* v__name);
    ~Vether_simulation_payload_FIFO();
    VL_UNCOPYABLE(Vether_simulation_payload_FIFO);
