...
VL_ATTR_COLD void Vether_simulation_IP_rx___stl_sequent__TOP__ether_simulation__svr_inst__ip_rx__0(Vether_simulation_IP_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_IP_rx___stl_sequent__TOP__ether_simulation__svr_inst__ip_rx__0\n"); );
...
VL_ATTR_COLD void Vether_simulation_IP_rx___stl_sequent__TOP__ether_simulation__svr_inst__ip_rx__1(Vether_simulation_IP_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_IP_rx___stl_sequent__TOP__ether_simulation__svr_inst__ip_rx__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    vlSelfRef.__PVT__nprotocol_data_flag = (0x28U < (IData)(vlSelfRef.__PVT__IP_len));
...
VL_ATTR_COLD void Vether_simulation_IP_rx___stl_sequent__TOP__ether_simulation__clt_inst__ip_rx__0(Vether_simulation_IP_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_IP_rx___stl_sequent__TOP__ether_simulation__clt_inst__ip_rx__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__chksum_pl = vlSelf->__PVT__chksum_inst->__PVT__TCP_checksum_pl;
...
VL_ATTR_COLD void Vether_simulation_IP_rx___stl_sequent__TOP__ether_simulation__clt_inst__ip_rx__1(Vether_simulation_IP_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_IP_rx___stl_sequent__TOP__ether_simulation__clt_inst__ip_rx__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    IData/*31:0*/ __Vtemp_1;
