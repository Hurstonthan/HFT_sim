...
VL_ATTR_COLD void VMAC_rx_priority_encoder__W10_Mz1___stl_sequent__TOP__MAC_rx__xgmii_fcs__0(VMAC_rx_priority_encoder__W10_Mz1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VMAC_rx_priority_encoder__W10_Mz1___stl_sequent__TOP__MAC_rx__xgmii_fcs__0\n"); );
...
VL_ATTR_COLD void VMAC_rx_priority_encoder__W10_Mz1___ctor_var_reset(VMAC_rx_priority_encoder__W10_Mz1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VMAC_rx_priority_encoder__W10_Mz1___ctor_var_reset\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
