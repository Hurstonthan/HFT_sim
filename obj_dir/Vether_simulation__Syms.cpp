...
Vether_simulation__Syms::Vether_simulation__Syms(VerilatedContext* contextp, const char* namep, Vether_simulation* modelp)
    ...
    , TOP__ether_simulation__clt_inst__u_tcp__tcp_flow__timewait{this, Verilated::catName(namep, "ether_simulation.clt_inst.u_tcp.tcp_flow.timewait")}
    ...
    , TOP__ether_simulation__svr_inst__u_tcp__tcp_flow__timewait{this, Verilated::catName(namep, "ether_simulation.svr_inst.u_tcp.tcp_flow.timewait")}
    ...
    , TOP__ether_simulation__svr_inst__u_tcp__timeout_fl{this, Verilated::catName(namep, "ether_simulation.svr_inst.u_tcp.timeout_fl")}
{
    ...
    TOP__ether_simulation__clt_inst__u_tcp__tcp_flow.__PVT__timewait = &TOP__ether_simulation__clt_inst__u_tcp__tcp_flow__timewait;
    ...
    TOP__ether_simulation__svr_inst__u_tcp__tcp_flow.__PVT__timewait = &TOP__ether_simulation__svr_inst__u_tcp__tcp_flow__timewait;
    ...
    TOP__ether_simulation__clt_inst__u_tcp__tcp_flow__timewait.__Vconfigure(true);
    ...
    TOP__ether_simulation__svr_inst.__Vconfigure(true);
    ...
    TOP__ether_simulation__svr_inst__u_tcp.__Vconfigure(true);
    TOP__ether_simulation__svr_inst__u_tcp__ISN_gen.__Vconfigure(true);
    ...
    TOP__ether_simulation__svr_inst__u_tcp__tcp_flow__timewait.__Vconfigure(false);
