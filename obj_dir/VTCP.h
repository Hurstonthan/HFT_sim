...
#ifndef VERILATED_VTCP_H_
#define VERILATED_VTCP_H_  // guard

#include "verilated.h"

class VTCP__Syms;
class VTCP___024root;
class VerilatedFstC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VTCP VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    explicit VTCP(VerilatedContext* contextp, const char* name = "TOP");
    explicit VTCP(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VTCP();
  private:
    VL_UNCOPYABLE(VTCP);  ///< Copying not allowed
