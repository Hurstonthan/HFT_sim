...
VL_INLINE_OPT void Vether_simulation_TCP_receiver___nba_sequent__TOP__ether_simulation__svr_inst__u_tcp__tcp_rcv__0(Vether_simulation_TCP_receiver* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_receiver___nba_sequent__TOP__ether_simulation__svr_inst__u_tcp__tcp_rcv__0\n"); );
...
VL_INLINE_OPT void Vether_simulation_TCP_receiver___nba_comb__TOP__ether_simulation__svr_inst__u_tcp__tcp_rcv__0(Vether_simulation_TCP_receiver* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_receiver___nba_comb__TOP__ether_simulation__svr_inst__u_tcp__tcp_rcv__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    if ((0U == (IData)(vlSelfRef.__PVT__state))) {
        if ((((IData)(vlSelfRef.__PVT__valid_IP_header_rx) 
              & (0x1234U == (0xffffU & VL_SEL_IQII(64, vlSelfRef.__PVT__IP_payload_rx, 0x20U, 0x10U)))) 
             & (0x5678U == (0xffffU & VL_SEL_IQII(64, vlSelfRef.__PVT__IP_payload_rx, 0x10U, 0x10U))))) {
            VL_ASSIGNSEL_II(32,16,0x10U, vlSelfRef.__PVT__nseq_num_rx, 
                            (0xffffU & VL_SEL_IQII(64, vlSelfRef.__PVT__IP_payload_rx, 0U, 0x10U)));
        ...
        vlSelfRef.__PVT__n_nw_segment = 1U;
        vlSelfRef.__PVT__nbytes_rcv = vlSelfRef.__PVT__IP_bytes_rcv;
        vlSelfRef.__PVT__temp = (0xfffffU & ((((VL_EXTEND_II(20,16, 
                                                             (0xffffU 
                                                              & VL_SEL_IIII(17, vlSelfRef.__PVT__TCP_checksum, 0U, 0x10U))) 
                                                + VL_EXTEND_II(20,16, 
...
VL_INLINE_OPT void Vether_simulation_TCP_receiver___nba_sequent__TOP__ether_simulation__clt_inst__u_tcp__tcp_rcv__0(Vether_simulation_TCP_receiver* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_receiver___nba_sequent__TOP__ether_simulation__clt_inst__u_tcp__tcp_rcv__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__Vdly__state = vlSelfRef.__PVT__state;
...
VL_INLINE_OPT void Vether_simulation_TCP_receiver___nba_comb__TOP__ether_simulation__clt_inst__u_tcp__tcp_rcv__0(Vether_simulation_TCP_receiver* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_receiver___nba_comb__TOP__ether_simulation__clt_inst__u_tcp__tcp_rcv__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    IData/*31:0*/ __Vtemp_1;
