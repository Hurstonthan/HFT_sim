...
VL_INLINE_OPT void Vether_simulation_MAC_rx___ico_sequent__TOP__ether_simulation__svr_inst__mac_rx__1(Vether_simulation_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_MAC_rx___ico_sequent__TOP__ether_simulation__svr_inst__mac_rx__1\n"); );
...
VL_INLINE_OPT void Vether_simulation_MAC_rx___ico_sequent__TOP__ether_simulation__clt_inst__mac_rx__1(Vether_simulation_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_MAC_rx___ico_sequent__TOP__ether_simulation__clt_inst__mac_rx__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__end_valid = vlSelf->__PVT__crc_check_encoder->__PVT__valid;
