...
#ifndef VERILATED_VETHER_SIMULATION_TCP__F10_H_
#define VERILATED_VETHER_SIMULATION_TCP__F10_H_  // guard

#include "verilated.h"
class Vether_simulation_TCP_ISN;
...
class alignas(VL_CACHE_LINE_BYTES) Vether_simulation_TCP__F10 final : public VerilatedModule {
  public:
    // CELLS
    ...
    Vether_simulation_TCP_ISN* __PVT__ISN_gen;
    ...
    // CONSTRUCTORS
    Vether_simulation_TCP__F10(Vether_simulation__Syms* symsp, const char* v__name);
    ~Vether_simulation_TCP__F10();
    VL_UNCOPYABLE(Vether_simulation_TCP__F10);
