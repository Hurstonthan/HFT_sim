...
VL_ATTR_COLD void Vethernet_rx_crc32_parallel_64bit___stl_sequent__TOP__ethernet_rx__mac_inst__CRC__0(Vethernet_rx_crc32_parallel_64bit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vethernet_rx_crc32_parallel_64bit___stl_sequent__TOP__ethernet_rx__mac_inst__CRC__0\n"); );
...
VL_ATTR_COLD void Vethernet_rx_crc32_parallel_64bit___stl_comb__TOP__ethernet_rx__mac_inst__CRC__0(Vethernet_rx_crc32_parallel_64bit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vethernet_rx_crc32_parallel_64bit___stl_comb__TOP__ethernet_rx__mac_inst__CRC__0\n"); );
    Vethernet_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vethernet_rx_crc32_parallel_64bit___ctor_var_reset(Vethernet_rx_crc32_parallel_64bit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vethernet_rx_crc32_parallel_64bit___ctor_var_reset\n"); );
    Vethernet_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
