...
void Vtop___024root__traceDeclTypesSub0(VerilatedFst* tracep) {
    ...
    }
    {
        ...
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11"};
        tracep->declDTypeEnum(4, "TCP_flow_ctrl.case_debug_t", 4, 2, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        = {"0", "1", "10", "11", "100", "101", "110", 
                                "111"};
        tracep->declDTypeEnum(5, "TCP_flow_ctrl.TCP_state_t", 8, 7, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11", "100", "101"};
        tracep->declDTypeEnum(6, "TCP_receiver.TCP_t", 6, 3, __VenumItemNames, __VenumItemValues);
    }
}
