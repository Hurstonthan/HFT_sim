...
VL_INLINE_OPT void Vether_simulation_payload_FIFO___ico_sequent__TOP__ether_simulation__svr_inst__u_payload_fifo__0(Vether_simulation_payload_FIFO* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_payload_FIFO___ico_sequent__TOP__ether_simulation__svr_inst__u_payload_fifo__0\n"); );
...
VL_INLINE_OPT void Vether_simulation_payload_FIFO___nba_sequent__TOP__ether_simulation__svr_inst__u_payload_fifo__0(Vether_simulation_payload_FIFO* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_payload_FIFO___nba_sequent__TOP__ether_simulation__svr_inst__u_payload_fifo__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    vlSelfRef.__Vdly__handshake = vlSelfRef.__PVT__handshake;
    ...
    if (vlSelfRef.__PVT__nRST) {
        ...
        vlSelfRef.__Vdly__handshake = vlSelfRef.__PVT__nhandshake;
        ...
        if (vlSelfRef.__PVT__handshake_done) {
            vlSelfRef.__Vdly__seq_trk_rd = vlSelfRef.__PVT__seq_rcv_start;
            vlSelfRef.__Vdly__handshake = vlSelfRef.__PVT__handshake_done;
        } else {
            vlSelfRef.__Vdly__seq_trk_rd = vlSelfRef.__PVT__nseq_trk_rd;
        }
        ...
        vlSelfRef.__Vdly__handshake = 0U;
    ...
    vlSelfRef.__PVT__handshake = vlSelfRef.__Vdly__handshake;
...
VL_INLINE_OPT void Vether_simulation_payload_FIFO___nba_comb__TOP__ether_simulation__svr_inst__u_payload_fifo__0(Vether_simulation_payload_FIFO* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_payload_FIFO___nba_comb__TOP__ether_simulation__svr_inst__u_payload_fifo__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__nwr_ptr = vlSelfRef.__PVT__wr_ptr;
...
VL_INLINE_OPT void Vether_simulation_payload_FIFO___ico_sequent__TOP__ether_simulation__clt_inst__u_payload_fifo__0(Vether_simulation_payload_FIFO* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_payload_FIFO___ico_sequent__TOP__ether_simulation__clt_inst__u_payload_fifo__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__nwr_ptr = vlSelfRef.__PVT__wr_ptr;
...
VL_INLINE_OPT void Vether_simulation_payload_FIFO___nba_sequent__TOP__ether_simulation__clt_inst__u_payload_fifo__0(Vether_simulation_payload_FIFO* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_payload_FIFO___nba_sequent__TOP__ether_simulation__clt_inst__u_payload_fifo__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlWide<3>/*95:0*/ __Vtemp_1;
...
VL_INLINE_OPT void Vether_simulation_payload_FIFO___nba_comb__TOP__ether_simulation__clt_inst__u_payload_fifo__0(Vether_simulation_payload_FIFO* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_payload_FIFO___nba_comb__TOP__ether_simulation__clt_inst__u_payload_fifo__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__nwr_ptr = vlSelfRef.__PVT__wr_ptr;
