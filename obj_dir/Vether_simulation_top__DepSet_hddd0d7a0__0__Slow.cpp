...
VL_ATTR_COLD void Vether_simulation_top___ctor_var_reset(Vether_simulation_top* vlSelf) {
    ...
    vlSelf->__Vcellinp__u_tcp__IP_bytes_rcv = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 4374233522320268461ull);
    vlSelf->__PVT__IP_bytes_rcv = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10742886468500543907ull);
}
