...
VL_ATTR_COLD void Vether_simulation_MAC_tx___stl_sequent__TOP__ether_simulation__svr_inst__mac_tx__0(Vether_simulation_MAC_tx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_MAC_tx___stl_sequent__TOP__ether_simulation__svr_inst__mac_tx__0\n"); );
...
VL_ATTR_COLD void Vether_simulation_MAC_tx___stl_sequent__TOP__ether_simulation__svr_inst__mac_tx__1(Vether_simulation_MAC_tx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_MAC_tx___stl_sequent__TOP__ether_simulation__svr_inst__mac_tx__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vether_simulation_MAC_tx___stl_sequent__TOP__ether_simulation__clt_inst__mac_tx__0(Vether_simulation_MAC_tx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_MAC_tx___stl_sequent__TOP__ether_simulation__clt_inst__mac_tx__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__xgmii_txd = vlSelfRef.__PVT__xgmii_txd_l;
...
VL_ATTR_COLD void Vether_simulation_MAC_tx___stl_sequent__TOP__ether_simulation__clt_inst__mac_tx__1(Vether_simulation_MAC_tx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_MAC_tx___stl_sequent__TOP__ether_simulation__clt_inst__mac_tx__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->__PVT__CRC->__PVT__nRST = vlSelfRef.__PVT__nRST;
