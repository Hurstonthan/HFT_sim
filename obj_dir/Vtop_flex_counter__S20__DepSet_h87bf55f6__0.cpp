...
VL_INLINE_OPT void Vtop_flex_counter__S20___nba_sequent__TOP__top__u_tcp__timeout_fl__0(Vtop_flex_counter__S20* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_flex_counter__S20___nba_sequent__TOP__top__u_tcp__timeout_fl__0\n"); );
...
VL_INLINE_OPT void Vtop_flex_counter__S20___nba_comb__TOP__top__u_tcp__timeout_fl__0(Vtop_flex_counter__S20* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_flex_counter__S20___nba_comb__TOP__top__u_tcp__timeout_fl__0\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
