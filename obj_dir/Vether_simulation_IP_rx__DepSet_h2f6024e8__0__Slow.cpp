...
VL_ATTR_COLD void Vether_simulation_IP_rx___ctor_var_reset(Vether_simulation_IP_rx* vlSelf) {
    ...
    vlSelf->__PVT__nprotocol_data_flag = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8232152594358192744ull);
    ...
    vlSelf->__Vdly__protocol_data_flag = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4679125851158764907ull);
}
