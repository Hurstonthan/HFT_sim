...
VL_ATTR_COLD void Vether_simulation_crc32_parallel_64bit___stl_sequent__TOP__ether_simulation__clt_inst__mac_tx__CRC__0(Vether_simulation_crc32_parallel_64bit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_crc32_parallel_64bit___stl_sequent__TOP__ether_simulation__clt_inst__mac_tx__CRC__0\n"); );
...
VL_ATTR_COLD void Vether_simulation_crc32_parallel_64bit___stl_sequent__TOP__ether_simulation__clt_inst__mac_tx__CRC__1(Vether_simulation_crc32_parallel_64bit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_crc32_parallel_64bit___stl_sequent__TOP__ether_simulation__clt_inst__mac_tx__CRC__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vether_simulation_crc32_parallel_64bit___ctor_var_reset(Vether_simulation_crc32_parallel_64bit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_crc32_parallel_64bit___ctor_var_reset\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
