...
#ifndef VERILATED_VETHER_SIMULATION_CHECKSUM_TCP_H_
#define VERILATED_VETHER_SIMULATION_CHECKSUM_TCP_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vether_simulation_checksum_TCP final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vether_simulation_checksum_TCP(Vether_simulation__Syms* symsp, const char* v__name);
    ~Vether_simulation_checksum_TCP();
    VL_UNCOPYABLE(Vether_simulation_checksum_TCP);
