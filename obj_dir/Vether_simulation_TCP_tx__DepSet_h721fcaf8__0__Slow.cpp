...
VL_ATTR_COLD void Vether_simulation_TCP_tx___eval_initial__TOP__ether_simulation__svr_inst__u_tcp__TCP_tx(Vether_simulation_TCP_tx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_tx___eval_initial__TOP__ether_simulation__svr_inst__u_tcp__TCP_tx\n"); );
...
VL_ATTR_COLD void Vether_simulation_TCP_tx___stl_sequent__TOP__ether_simulation__svr_inst__u_tcp__TCP_tx__0(Vether_simulation_TCP_tx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_tx___stl_sequent__TOP__ether_simulation__svr_inst__u_tcp__TCP_tx__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vether_simulation_TCP_tx___eval_initial__TOP__ether_simulation__clt_inst__u_tcp__TCP_tx(Vether_simulation_TCP_tx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_tx___eval_initial__TOP__ether_simulation__clt_inst__u_tcp__TCP_tx\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__src_port = 0x1234U;
...
VL_ATTR_COLD void Vether_simulation_TCP_tx___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__TCP_tx__0(Vether_simulation_TCP_tx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_tx___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__TCP_tx__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    IData/*31:0*/ __Vtemp_1;
...
VL_ATTR_COLD void Vether_simulation_TCP_tx___ctor_var_reset(Vether_simulation_TCP_tx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_tx___ctor_var_reset\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->__PVT__chksum_debug = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 3684636523579521620ull);
    vlSelf->__PVT__IP_pseuder_debug = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 6803334456367407090ull);
    vlSelf->__PVT__IP_pseuder_temp = VL_SCOPED_RAND_RESET_I(20, __VscopeHash, 11399679182377794034ull);
    vlSelf->__PVT__frame_hold = VL_SCOPED_RAND_RESET_Q(48, __VscopeHash, 2601007176825285797ull);
    vlSelf->__PVT__nframe_hold = VL_SCOPED_RAND_RESET_Q(48, __VscopeHash, 11083986970244112413ull);
    ...
    vlSelf->__Vdly__frame_hold = VL_SCOPED_RAND_RESET_Q(48, __VscopeHash, 14060925314608219289ull);
