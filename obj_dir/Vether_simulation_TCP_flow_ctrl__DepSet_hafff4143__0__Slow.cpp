...
VL_ATTR_COLD void Vether_simulation_TCP_flow_ctrl___stl_sequent__TOP__ether_simulation__svr_inst__u_tcp__tcp_flow__0(Vether_simulation_TCP_flow_ctrl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_flow_ctrl___stl_sequent__TOP__ether_simulation__svr_inst__u_tcp__tcp_flow__0\n"); );
...
VL_ATTR_COLD void Vether_simulation_TCP_flow_ctrl___stl_sequent__TOP__ether_simulation__svr_inst__u_tcp__tcp_flow__1(Vether_simulation_TCP_flow_ctrl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_flow_ctrl___stl_sequent__TOP__ether_simulation__svr_inst__u_tcp__tcp_flow__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vether_simulation_TCP_flow_ctrl___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__tcp_flow__0(Vether_simulation_TCP_flow_ctrl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_flow_ctrl___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__tcp_flow__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__rcv_next_out = vlSelfRef.__PVT__rcv_next;
...
VL_ATTR_COLD void Vether_simulation_TCP_flow_ctrl___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__tcp_flow__1(Vether_simulation_TCP_flow_ctrl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_TCP_flow_ctrl___stl_sequent__TOP__ether_simulation__clt_inst__u_tcp__tcp_flow__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->__PVT__timewait->__PVT__nRST = vlSelfRef.__PVT__nRST;
