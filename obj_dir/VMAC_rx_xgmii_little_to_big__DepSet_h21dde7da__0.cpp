...
VL_INLINE_OPT void VMAC_rx_xgmii_little_to_big___ico_sequent__TOP__MAC_rx__crc_convert__0(VMAC_rx_xgmii_little_to_big* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VMAC_rx_xgmii_little_to_big___ico_sequent__TOP__MAC_rx__crc_convert__0\n"); );
