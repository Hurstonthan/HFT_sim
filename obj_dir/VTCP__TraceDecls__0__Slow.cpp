...
void VTCP___024root__traceDeclTypesSub0(VerilatedFst* tracep) {
    {
        ...
        = {"0", "1", "10", "11", "100"};
        tracep->declDTypeEnum(1, "TCP_tx.TCP_state_t", 5, 7, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11"};
        tracep->declDTypeEnum(2, "TCP_flow_ctrl.case_debug_t", 4, 2, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        = {"0", "1", "10", "11", "100", "101", "110", 
                                "111"};
        tracep->declDTypeEnum(3, "TCP_flow_ctrl.TCP_state_t", 8, 7, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
...
void VTCP___024root__trace_decl_types(VerilatedFst* tracep) {
    VTCP___024root__traceDeclTypesSub0(tracep);
}
