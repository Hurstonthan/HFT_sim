...
VL_ATTR_COLD void Vtop_payload_FIFO__F5___stl_sequent__TOP__top__u_payload_fifo__0(Vtop_payload_FIFO__F5* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_payload_FIFO__F5___stl_sequent__TOP__top__u_payload_fifo__0\n"); );
...
VL_ATTR_COLD void Vtop_payload_FIFO__F5___stl_sequent__TOP__top__u_payload_fifo__1(Vtop_payload_FIFO__F5* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_payload_FIFO__F5___stl_sequent__TOP__top__u_payload_fifo__1\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtop_payload_FIFO__F5___ctor_var_reset(Vtop_payload_FIFO__F5* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_payload_FIFO__F5___ctor_var_reset\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->__PVT__wr_ptr_out = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 14280824392925468497ull);
    vlSelf->__PVT__wr_FIFO_len = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 1454357461022193599ull);
    vlSelf->__PVT__rd_FIFO_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 615369904805283052ull);
    vlSelf->__PVT__rd_FIFO_ptr = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 1541493805853970047ull);
    vlSelf->__PVT__rd_FIFO_len = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 4311993884634595022ull);
    ...
    vlSelf->__PVT__flush_ptr = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 12629206001683931762ull);
    vlSelf->__PVT__nflush_ptr = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 4733891924914347654ull);
    vlSelf->__PVT__len_TCP_flush = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 16207856346514006386ull);
    vlSelf->__PVT__nlen_TCP_flush = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 434479146916130705ull);
    vlSelf->__PVT__rd_len_ptr = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 1323015811732051027ull);
    ...
    vlSelf->__PVT__nwr_ptr = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 1876698004006870143ull);
    vlSelf->__PVT__rd_ptr = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 8582113012353463185ull);
    vlSelf->__PVT__nrd_ptr = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 8308338580089836589ull);
    vlSelf->__PVT__unnamedblk1__DOT__i = 0;
    VL_SCOPED_RAND_RESET_W(72, vlSelf->__Vlvbound_he08b30c9__0, __VscopeHash, 17987630567645677538ull);
    VL_SCOPED_RAND_RESET_W(72, vlSelf->__Vlvbound_hbbd841ec__0, __VscopeHash, 8491822756216384121ull);
    vlSelf->__Vlvbound_hf0dde044__0 = VL_SCOPED_RAND_RESET_Q(64, __VscopeHash, 4877786756303145658ull);
    vlSelf->__Vlvbound_h48178a4d__0 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 5846414944466162151ull);
    ...
    vlSelf->__Vdly__flush_ptr = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 16317277963448058588ull);
    vlSelf->__Vdly__len_TCP_flush = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 4499794943241228148ull);
    ...
    vlSelf->__Vdly__wr_FIFO_len = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 2463755035948012911ull);
    vlSelf->__Vdly__wr_ptr_out = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 11191159754855846327ull);
    vlSelf->__Vdly__axis_rd_data = VL_SCOPED_RAND_RESET_Q(64, __VscopeHash, 17392126712206161775ull);
    vlSelf->__Vdly__rd_len_ptr = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 10418901856708786751ull);
