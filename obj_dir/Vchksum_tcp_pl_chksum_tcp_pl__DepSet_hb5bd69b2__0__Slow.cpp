...
VL_ATTR_COLD void Vchksum_tcp_pl_chksum_tcp_pl___stl_sequent__TOP__chksum_tcp_pl__0(Vchksum_tcp_pl_chksum_tcp_pl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vchksum_tcp_pl_chksum_tcp_pl___stl_sequent__TOP__chksum_tcp_pl__0\n"); );
...
VL_ATTR_COLD void Vchksum_tcp_pl_chksum_tcp_pl___ctor_var_reset(Vchksum_tcp_pl_chksum_tcp_pl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vchksum_tcp_pl_chksum_tcp_pl___ctor_var_reset\n"); );
    Vchksum_tcp_pl__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
