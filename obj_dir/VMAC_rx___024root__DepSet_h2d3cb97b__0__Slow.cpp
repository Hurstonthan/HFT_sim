...
VL_ATTR_COLD void VMAC_rx_xgmii_little_to_big___stl_sequent__TOP__MAC_rx__crc_convert__1(VMAC_rx_xgmii_little_to_big* vlSelf);
...
VL_ATTR_COLD void VMAC_rx___024root___eval_stl(VMAC_rx___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        ...
        VMAC_rx_xgmii_little_to_big___stl_sequent__TOP__MAC_rx__crc_convert__1((&vlSymsp->TOP__MAC_rx__crc_convert));
        VMAC_rx_MAC_rx___stl_sequent__TOP__MAC_rx__2((&vlSymsp->TOP__MAC_rx));
        VMAC_rx_crc32_parallel_64bit___stl_sequent__TOP__MAC_rx__CRC__1((&vlSymsp->TOP__MAC_rx__CRC));
    }
}
