...
VL_ATTR_COLD void VIP_rx___024root___ctor_var_reset(VIP_rx___024root* vlSelf) {
    ...
    vlSelf->IP_rx__DOT__test_valid = VL_RAND_RESET_I(4);
    vlSelf->IP_rx__DOT__ip_version = VL_RAND_RESET_I(4);
    vlSelf->IP_rx__DOT__is_src_addr = VL_RAND_RESET_I(1);
    vlSelf->IP_rx__DOT__is_ip_version_valid = VL_RAND_RESET_I(1);
