...
VL_ATTR_COLD void Vtop_TCP__F5___eval_initial__TOP__top__u_tcp(Vtop_TCP__F5* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_TCP__F5___eval_initial__TOP__top__u_tcp\n"); );
...
VL_ATTR_COLD void Vtop_TCP__F5___stl_sequent__TOP__top__u_tcp__0(Vtop_TCP__F5* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_TCP__F5___stl_sequent__TOP__top__u_tcp__0\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelfRef.__Vcellinp__tcp_flow__wr_FIFO_ptr = VL_EXTEND_II(11,1, (IData)(vlSelfRef.__PVT__wr_FIFO_ptr_out));
...
VL_ATTR_COLD void Vtop_TCP__F5___stl_sequent__TOP__top__u_tcp__1(Vtop_TCP__F5* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_TCP__F5___stl_sequent__TOP__top__u_tcp__1\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtop_TCP__F5___stl_sequent__TOP__top__u_tcp__2(Vtop_TCP__F5* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_TCP__F5___stl_sequent__TOP__top__u_tcp__2\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtop_TCP__F5___stl_sequent__TOP__top__u_tcp__3(Vtop_TCP__F5* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_TCP__F5___stl_sequent__TOP__top__u_tcp__3\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
