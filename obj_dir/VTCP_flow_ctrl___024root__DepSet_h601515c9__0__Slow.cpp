...
VL_ATTR_COLD void VTCP_flow_ctrl___024root___eval_static(VTCP_flow_ctrl___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP_flow_ctrl___024root___eval_static\n"); );
...
VL_ATTR_COLD void VTCP_flow_ctrl___024root___eval_initial__TOP(VTCP_flow_ctrl___024root* vlSelf);

VL_ATTR_COLD void VTCP_flow_ctrl___024root___eval_initial(VTCP_flow_ctrl___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP_flow_ctrl___024root___eval_initial\n"); );
    VTCP_flow_ctrl__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VTCP_flow_ctrl___024root___eval_initial__TOP(vlSelf);
}

VL_ATTR_COLD void VTCP_flow_ctrl___024root___eval_initial__TOP(VTCP_flow_ctrl___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP_flow_ctrl___024root___eval_initial__TOP\n"); );
    VTCP_flow_ctrl__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VTCP_flow_ctrl___024root___eval_final(VTCP_flow_ctrl___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP_flow_ctrl___024root___eval_final\n"); );
    VTCP_flow_ctrl__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void VTCP_flow_ctrl___024root___dump_triggers__stl(VTCP_flow_ctrl___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool VTCP_flow_ctrl___024root___eval_phase__stl(VTCP_flow_ctrl___024root* vlSelf);

VL_ATTR_COLD void VTCP_flow_ctrl___024root___eval_settle(VTCP_flow_ctrl___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP_flow_ctrl___024root___eval_settle\n"); );
    VTCP_flow_ctrl__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#ifdef VL_DEBUG
            VTCP_flow_ctrl___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("rtl/TCP_flow_ctrl.sv", 5, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (VTCP_flow_ctrl___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
#ifdef VL_DEBUG
VL_ATTR_COLD void VTCP_flow_ctrl___024root___dump_triggers__stl(VTCP_flow_ctrl___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP_flow_ctrl___024root___dump_triggers__stl\n"); );
    VTCP_flow_ctrl__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VTCP_flow_ctrl___024root___stl_sequent__TOP__0(VTCP_flow_ctrl___024root* vlSelf);
...
VL_ATTR_COLD void VTCP_flow_ctrl___024root___eval_stl(VTCP_flow_ctrl___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP_flow_ctrl___024root___eval_stl\n"); );
    VTCP_flow_ctrl__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VTCP_flow_ctrl___024root___stl_sequent__TOP__0(vlSelf);
        VTCP_flow_ctrl___024root____Vm_traceActivitySetAll(vlSelf);
    }
}

VL_ATTR_COLD void VTCP_flow_ctrl___024root___stl_sequent__TOP__0(VTCP_flow_ctrl___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP_flow_ctrl___024root___stl_sequent__TOP__0\n"); );
    VTCP_flow_ctrl__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    // Body
    vlSelfRef.window_size_tx = ((IData)(vlSelfRef.full)
                                 ? 0U : 0xffffU);
