...
VL_ATTR_COLD void Vether_simulation_FIFO_TX__F10___stl_sequent__TOP__ether_simulation__svr_inst__u_fifo_tx__0(Vether_simulation_FIFO_TX__F10* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_FIFO_TX__F10___stl_sequent__TOP__ether_simulation__svr_inst__u_fifo_tx__0\n"); );
...
VL_ATTR_COLD void Vether_simulation_FIFO_TX__F10___stl_sequent__TOP__ether_simulation__svr_inst__u_fifo_tx__1(Vether_simulation_FIFO_TX__F10* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_FIFO_TX__F10___stl_sequent__TOP__ether_simulation__svr_inst__u_fifo_tx__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vether_simulation_FIFO_TX__F10___stl_sequent__TOP__ether_simulation__clt_inst__u_fifo_tx__0(Vether_simulation_FIFO_TX__F10* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_FIFO_TX__F10___stl_sequent__TOP__ether_simulation__clt_inst__u_fifo_tx__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__empty = ((IData)(vlSelfRef.__PVT__wrt_ptr) 
...
VL_ATTR_COLD void Vether_simulation_FIFO_TX__F10___stl_sequent__TOP__ether_simulation__clt_inst__u_fifo_tx__1(Vether_simulation_FIFO_TX__F10* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_FIFO_TX__F10___stl_sequent__TOP__ether_simulation__clt_inst__u_fifo_tx__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__nwrt_ptr = vlSelfRef.__PVT__wrt_ptr;
...
VL_ATTR_COLD void Vether_simulation_FIFO_TX__F10___ctor_var_reset(Vether_simulation_FIFO_TX__F10* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_FIFO_TX__F10___ctor_var_reset\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->__Vlvbound_ha3926224__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15262839936275706274ull);
    vlSelf->__Vlvbound_hf7e9052d__0 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 14245053613467119927ull);
    vlSelf->__Vlvbound_hf96d897b__0 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 5233331053436094009ull);
    vlSelf->__Vlvbound_hed5a7686__0 = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 4361495180341308808ull);
    vlSelf->__Vlvbound_h314b6349__0 = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 482154956374222318ull);
    vlSelf->__Vlvbound_heabe4560__0 = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 17244721166103460232ull);
