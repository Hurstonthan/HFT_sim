...
VL_INLINE_OPT void VMAC_rx_MAC_rx___ico_sequent__TOP__MAC_rx__0(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___ico_sequent__TOP__MAC_rx__0\n"); );
    ...
    if ((((0U == (IData)(vlSelfRef.__PVT__state)) & 
          VL_BITSEL_IIII(8, (IData)(vlSelfRef.xgmii_rxc), 0U)) 
         & (0xfbU == (0xffU & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 0U, 8U))))) {
        vlSelfRef.__PVT__nsof_found = 1U;
        vlSelfRef.__PVT__nsof_lane = 0U;
    }
    vlSelfRef.__PVT__i = 1U;
    if ((((0U == (IData)(vlSelfRef.__PVT__state)) & 
          VL_BITSEL_IIII(8, (IData)(vlSelfRef.xgmii_rxc), 1U)) 
         & (0xfbU == (0xffU & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 8U, 8U))))) {
        vlSelfRef.__PVT__nsof_found = 1U;
        vlSelfRef.__PVT__nsof_lane = 1U;
    }
    vlSelfRef.__PVT__i = 2U;
    if ((((0U == (IData)(vlSelfRef.__PVT__state)) & 
          VL_BITSEL_IIII(8, (IData)(vlSelfRef.xgmii_rxc), 2U)) 
         & (0xfbU == (0xffU & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 0x10U, 8U))))) {
        vlSelfRef.__PVT__nsof_found = 1U;
        vlSelfRef.__PVT__nsof_lane = 2U;
    }
    vlSelfRef.__PVT__i = 3U;
    if ((((0U == (IData)(vlSelfRef.__PVT__state)) & 
          VL_BITSEL_IIII(8, (IData)(vlSelfRef.xgmii_rxc), 3U)) 
         & (0xfbU == (0xffU & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 0x18U, 8U))))) {
        vlSelfRef.__PVT__nsof_found = 1U;
        vlSelfRef.__PVT__nsof_lane = 3U;
    }
    vlSelfRef.__PVT__i = 4U;
    if ((((0U == (IData)(vlSelfRef.__PVT__state)) & 
          VL_BITSEL_IIII(8, (IData)(vlSelfRef.xgmii_rxc), 4U)) 
         & (0xfbU == (0xffU & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 0x20U, 8U))))) {
        vlSelfRef.__PVT__nsof_found = 1U;
        vlSelfRef.__PVT__nsof_lane = 4U;
    }
    vlSelfRef.__PVT__i = 5U;
    if ((((0U == (IData)(vlSelfRef.__PVT__state)) & 
          VL_BITSEL_IIII(8, (IData)(vlSelfRef.xgmii_rxc), 5U)) 
         & (0xfbU == (0xffU & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 0x28U, 8U))))) {
        vlSelfRef.__PVT__nsof_found = 1U;
        vlSelfRef.__PVT__nsof_lane = 5U;
    }
    vlSelfRef.__PVT__i = 6U;
    if ((((0U == (IData)(vlSelfRef.__PVT__state)) & 
          VL_BITSEL_IIII(8, (IData)(vlSelfRef.xgmii_rxc), 6U)) 
         & (0xfbU == (0xffU & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 0x30U, 8U))))) {
        vlSelfRef.__PVT__nsof_found = 1U;
        vlSelfRef.__PVT__nsof_lane = 6U;
    }
    vlSelfRef.__PVT__i = 7U;
    if ((((0U == (IData)(vlSelfRef.__PVT__state)) & 
          VL_BITSEL_IIII(8, (IData)(vlSelfRef.xgmii_rxc), 7U)) 
         & (0xfbU == (0xffU & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 0x38U, 8U))))) {
        vlSelfRef.__PVT__nsof_found = 1U;
...
VL_INLINE_OPT void VMAC_rx_MAC_rx___ico_sequent__TOP__MAC_rx__1(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___ico_sequent__TOP__MAC_rx__1\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    VL_CONCAT_WQQ(128,64,64, vlSelfRef.__PVT__nframe_store, vlSelfRef.xgmii_rxd, 
                  VL_SEL_QWII(128, vlSelfRef.__PVT__frame_store, 0x40U, 0x40U));
    vlSelfRef.__PVT__nMAC_payload_rcv = vlSelfRef.MAC_payload_rcv;
    ...
    if ((0U == (IData)(vlSelfRef.__PVT__state))) {
        ...
        vlSelfRef.__PVT__crc_init = 0U;
        if (((0xffffffccbbaaULL == (0xffffffffffffULL 
                                    & VL_SEL_QQII(64, vlSelfRef.__PVT__xgmii_rxd_f, 0U, 0x30U))) 
             & (0xaaccU == (0xffffU & VL_SEL_IQII(64, vlSelfRef.__PVT__xgmii_rxd_f, 0x30U, 0x10U))))) {
        ...
        if (((0xbbffffffU == VL_SEL_IQII(64, vlSelfRef.__PVT__xgmii_rxd_f, 0U, 0x20U)) 
             & (0x800U == (0xffffU & VL_SEL_IQII(64, vlSelfRef.__PVT__xgmii_rxd_f, 0x20U, 0x10U))))) {
            vlSelfRef.__PVT__next_state = 3U;
            vlSelfRef.__PVT__nMAC_payload_rcv = VL_CONCAT_QIQ(64,16,48, 
                                                              (0xffffU 
        ...
        vlSelfRef.__PVT__nMAC_valid = 1U;
        vlSelfRef.__PVT__nMAC_payload_rcv = vlSelfRef.__PVT__xgmii_rxd_f;
            ...
            if ((0U == (IData)(vlSelfRef.__PVT__sof_lane))) {
                if ((5U > (IData)(vlSelfRef.__PVT__bytes_offset))) {
                    ...
                    if ((0U == (IData)(vlSelfRef.__PVT__bytes_offset))) {
                        vlSelfRef.__PVT__nMAC_payload_rcv 
                    ...
                    vlSelfRef.__PVT__xgmii_rxd_f = vlSelfRef.__PVT__nMAC_payload_rcv;
                    ...
                    if ((5U == (IData)(vlSelfRef.__PVT__bytes_offset))) {
                        VL_CONCAT_WQQ(128,64,64, vlSelfRef.__PVT__nframe_store, 
                                      VL_EXTEND_QI(64,8, 
                                                   (0xffU 
                                                    & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 0U, 8U))), 
                                      VL_SEL_QWII(128, vlSelfRef.__PVT__frame_store, 0x40U, 0x40U));
                        ...
                        VL_EXTEND_WI(73,17, __Vtemp_2, 
                                     (0x1ffffU & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 0U, 0x11U)));
                        ...
                        VL_EXTEND_WI(80,24, __Vtemp_3, 
                                     (0xffffffU & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 0U, 0x18U)));
                        VL_ASSIGNSEL_WQ(128,64,0x40U, vlSelfRef.__PVT__nframe_store, 
                ...
                if (((((((((7U == (IData)(vlSelfRef.__PVT__bytes_offset)) 
                    ...
                    if ((7U == (IData)(vlSelfRef.__PVT__bytes_offset))) {
                        VL_CONCAT_WQQ(128,64,64, vlSelfRef.__PVT__nframe_store, 
                                      VL_EXTEND_QI(64,24, 
                                                   (0xffffffU 
                                                    & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 0U, 0x18U))), 
                                      VL_SEL_QWII(128, vlSelfRef.__PVT__frame_store, 0x40U, 0x40U));
                    } else if ((6U == (IData)(vlSelfRef.__PVT__bytes_offset))) {
                        VL_CONCAT_WQQ(128,64,64, vlSelfRef.__PVT__nframe_store, 
                                      VL_EXTEND_QI(64,16, 
                                                   (0xffffU 
                                                    & VL_SEL_IQII(64, vlSelfRef.xgmii_rxd, 0U, 0x10U))), 
                                      VL_SEL_QWII(128, vlSelfRef.__PVT__frame_store, 0x40U, 0x40U));
        ...
        if ((vlSelfRef.__PVT__crc_out == VL_SEL_IQII(64, vlSelfRef.__PVT__FCS_frame_cvt, 0U, 0x20U))) {
            ...
            vlSelfRef.CRC_flush = 1U;
            vlSelfRef.__PVT__next_state = 5U;
        }
    }
    vlSymsp->TOP__MAC_rx__CRC.__PVT__crc_init = vlSelfRef.__PVT__crc_init;
    vlSymsp->TOP__MAC_rx__CRC.__PVT__valid = vlSelfRef.__PVT__crc_valid;
    vlSelfRef.__PVT__mac_dest_addr = (0xffffffffffffULL 
                                      & VL_SEL_QQII(64, vlSelfRef.__PVT__xgmii_rxd_f, 0U, 0x30U));
    ...
    vlSymsp->TOP__MAC_rx__crc_convert.__PVT__xgmii_rxd 
        = vlSelfRef.__PVT__crc_in;
}

VL_INLINE_OPT void VMAC_rx_MAC_rx___ico_sequent__TOP__MAC_rx__2(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___ico_sequent__TOP__MAC_rx__2\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__crc_in_big = vlSymsp->TOP__MAC_rx__crc_convert.__PVT__be_rxd;
    vlSymsp->TOP__MAC_rx__CRC.__PVT__data_in = vlSelfRef.__PVT__crc_in_big;
}

VL_INLINE_OPT void VMAC_rx_MAC_rx___nba_sequent__TOP__MAC_rx__0(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___nba_sequent__TOP__MAC_rx__0\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_INLINE_OPT void VMAC_rx_MAC_rx___nba_sequent__TOP__MAC_rx__1(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___nba_sequent__TOP__MAC_rx__1\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelfRef.__Vdly__MAC_valid = vlSelfRef.MAC_valid;
    vlSelfRef.__Vdly__MAC_payload_rcv = vlSelfRef.MAC_payload_rcv;
    ...
    if (vlSelfRef.nRST) {
        ...
        vlSelfRef.__Vdly__MAC_payload_rcv = vlSelfRef.__PVT__nMAC_payload_rcv;
        ...
        vlSelfRef.__Vdly__MAC_payload_rcv = 0ULL;
    ...
    vlSelfRef.MAC_valid = vlSelfRef.__Vdly__MAC_valid;
    vlSelfRef.MAC_payload_rcv = vlSelfRef.__Vdly__MAC_payload_rcv;
    ...
    vlSelfRef.bytes_rcv_len = vlSelfRef.__PVT__bytes_rcv;
    vlSelfRef.__PVT__nsof_found = vlSelfRef.__PVT__sof_found;
    vlSelfRef.__PVT__nsof_lane = vlSelfRef.__PVT__sof_lane;
    if ((((0U == (IData)(vlSelfRef.__PVT__state)) & 
          VL_BITSEL_IIII(8, (IData)(vlSelfRef.xgmii_rxc), 0U)) 
...
VL_INLINE_OPT void VMAC_rx_MAC_rx___nba_sequent__TOP__MAC_rx__2(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___nba_sequent__TOP__MAC_rx__2\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_INLINE_OPT void VMAC_rx_MAC_rx___nba_comb__TOP__MAC_rx__0(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___nba_comb__TOP__MAC_rx__0\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlWide<4>/*127:0*/ __Vtemp_1;
...
VL_INLINE_OPT void VMAC_rx_MAC_rx___nba_comb__TOP__MAC_rx__1(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___nba_comb__TOP__MAC_rx__1\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__crc_in_big = vlSymsp->TOP__MAC_rx__crc_convert.__PVT__be_rxd;
