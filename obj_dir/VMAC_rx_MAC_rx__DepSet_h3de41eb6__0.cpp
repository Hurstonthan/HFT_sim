...
VL_INLINE_OPT void VMAC_rx_MAC_rx___ico_comb__TOP__MAC_rx__0(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___ico_comb__TOP__MAC_rx__0\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_INLINE_OPT void VMAC_rx_MAC_rx___ico_comb__TOP__MAC_rx__1(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___ico_comb__TOP__MAC_rx__1\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_INLINE_OPT void VMAC_rx_MAC_rx___act_sequent__TOP__MAC_rx__0(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___act_sequent__TOP__MAC_rx__0\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlWide<3>/*95:0*/ __Vtemp_1;
...
VL_INLINE_OPT void VMAC_rx_MAC_rx___act_sequent__TOP__MAC_rx__1(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___act_sequent__TOP__MAC_rx__1\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__crc_in_big = vlSymsp->TOP__MAC_rx__crc_convert.__PVT__be_rxd;
...
VL_INLINE_OPT void VMAC_rx_MAC_rx___nba_sequent__TOP__MAC_rx__1(VMAC_rx_MAC_rx* vlSelf) {
    ...
    vlSelfRef.__PVT__i = 8U;
    vlSymsp->TOP__MAC_rx__payload_cvrt.__PVT__xgmii_rxd 
