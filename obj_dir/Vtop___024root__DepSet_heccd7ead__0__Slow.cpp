...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(Vtop___024root* vlSelf) {
    ...
    if ((0x4000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 14 is active: @(posedge top.u_tcp.timeout_fl.CLK)\n");
    }
    if ((0x8000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 15 is active: @(negedge top.u_tcp.timeout_fl.nRST)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__nba(Vtop___024root* vlSelf) {
    ...
    if ((0x4000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 14 is active: @(posedge top.u_tcp.timeout_fl.CLK)\n");
    }
    if ((0x8000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 15 is active: @(negedge top.u_tcp.timeout_fl.nRST)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vtrigprevexpr___TOP__top__u_tcp__timeout_fl____PVT__CLK__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2340510729405417900ull);
    vlSelf->__Vtrigprevexpr___TOP__top__u_tcp__timeout_fl____PVT__nRST__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16273097696615394087ull);
