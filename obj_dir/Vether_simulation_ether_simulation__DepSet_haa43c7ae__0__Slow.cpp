...
VL_ATTR_COLD void Vether_simulation_ether_simulation___eval_initial__TOP__ether_simulation(Vether_simulation_ether_simulation* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vether_simulation_ether_simulation___eval_initial__TOP__ether_simulation\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSymsp->TOP__ether_simulation__svr_inst.__PVT__out_order = 0U;
}
