...
void VFIFO_TX___024root__trace_chg_0_sub_0(VFIFO_TX___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+219,(vlSelfRef.CLK));
    bufp->chgBit(oldp+220,(vlSelfRef.nRST));
    bufp->chgBit(oldp+221,(vlSelfRef.seq_up));
    bufp->chgIData(oldp+222,(vlSelfRef.seq_num_tx),32);
    bufp->chgBit(oldp+223,(vlSelfRef.rd_FIFO_en));
    bufp->chgBit(oldp+224,(vlSelfRef.rd_FIFO_valid));
    bufp->chgBit(oldp+225,(vlSelfRef.rd_FIFO_last));
    bufp->chgQData(oldp+226,(vlSelfRef.rd_FIFO_payload),64);
    bufp->chgSData(oldp+228,(vlSelfRef.bytes_abt_sent),16);
    bufp->chgIData(oldp+229,(vlSelfRef.ACK_num),32);
    bufp->chgBit(oldp+230,(vlSelfRef.ACK_rcv_flag));
    bufp->chgBit(oldp+231,(vlSelfRef.out_order_req));
    bufp->chgBit(oldp+232,(vlSelfRef.axis_last));
    bufp->chgBit(oldp+233,(vlSelfRef.wr_FIFO_en));
    bufp->chgIData(oldp+234,(vlSelfRef.len_seq),32);
    bufp->chgQData(oldp+235,(vlSelfRef.soupbin_TCP_payload),64);
    bufp->chgBit(oldp+237,(vlSelfRef.wr_FIFO_valid));
}
