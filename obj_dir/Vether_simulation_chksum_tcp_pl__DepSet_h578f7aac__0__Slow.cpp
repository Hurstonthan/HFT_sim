...
VL_ATTR_COLD void Vether_simulation_chksum_tcp_pl___stl_sequent__TOP__ether_simulation__svr_inst__ip_rx__chksum_inst__0(Vether_simulation_chksum_tcp_pl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_chksum_tcp_pl___stl_sequent__TOP__ether_simulation__svr_inst__ip_rx__chksum_inst__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__TCP_checksum_pl = (0xffffU & VL_SEL_IIII(17, vlSelfRef.__PVT__TCP_checksum, 0U, 0x10U));
}
...
VL_ATTR_COLD void Vether_simulation_chksum_tcp_pl___stl_sequent__TOP__ether_simulation__svr_inst__ip_rx__chksum_inst__1(Vether_simulation_chksum_tcp_pl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_chksum_tcp_pl___stl_sequent__TOP__ether_simulation__svr_inst__ip_rx__chksum_inst__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vether_simulation_chksum_tcp_pl___stl_sequent__TOP__ether_simulation__clt_inst__ip_rx__chksum_inst__0(Vether_simulation_chksum_tcp_pl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_chksum_tcp_pl___stl_sequent__TOP__ether_simulation__clt_inst__ip_rx__chksum_inst__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__TCP_checksum_pl = (0xffffU & VL_SEL_IIII(17, vlSelfRef.__PVT__TCP_checksum, 0U, 0x10U));
...
VL_ATTR_COLD void Vether_simulation_chksum_tcp_pl___stl_sequent__TOP__ether_simulation__clt_inst__ip_rx__chksum_inst__1(Vether_simulation_chksum_tcp_pl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_chksum_tcp_pl___stl_sequent__TOP__ether_simulation__clt_inst__ip_rx__chksum_inst__1\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    IData/*31:0*/ __Vtemp_1;
...
VL_ATTR_COLD void Vether_simulation_chksum_tcp_pl___ctor_var_reset(Vether_simulation_chksum_tcp_pl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vether_simulation_chksum_tcp_pl___ctor_var_reset\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
