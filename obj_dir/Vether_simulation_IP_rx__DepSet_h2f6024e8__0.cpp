...
VL_INLINE_OPT void Vether_simulation_IP_rx___nba_sequent__TOP__ether_simulation__svr_inst__ip_rx__1(Vether_simulation_IP_rx* vlSelf) {
    ...
    vlSelfRef.__Vdly__protocol_data_flag = vlSelfRef.__PVT__protocol_data_flag;
    ...
    if (vlSelfRef.__PVT__nRST) {
        ...
        vlSelfRef.__Vdly__protocol_data_flag = vlSelfRef.__PVT__nprotocol_data_flag;
    } else {
        ...
        vlSelfRef.__Vdly__protocol_data_flag = 0U;
    }
    ...
    vlSelfRef.__PVT__protocol_data_flag = vlSelfRef.__Vdly__protocol_data_flag;
