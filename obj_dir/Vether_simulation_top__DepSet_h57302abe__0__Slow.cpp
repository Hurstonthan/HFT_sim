...
VL_ATTR_COLD void Vether_simulation_top___stl_sequent__TOP__ether_simulation__clt_inst__0(Vether_simulation_top* vlSelf) {
    ...
    // Body
    vlSymsp->TOP__ether_simulation__clt_inst__u_fifo_tx.__PVT__seq_up 
    ...
    vlSelfRef.__PVT__TCP_stop_flg_int = vlSymsp->TOP__ether_simulation__clt_inst__u_fifo_tx.__PVT__TCP_stop_flag;
    ...
    vlSelfRef.__PVT__checksum_re_trans_int = vlSymsp->TOP__ether_simulation__clt_inst__u_fifo_tx.__PVT__checksum_re_trans;
    ...
    vlSymsp->TOP__ether_simulation__clt_inst__u_tcp.__PVT__checksum_re_trans 
