...
#ifndef VERILATED_VTOP_TCP_TX_H_
#define VERILATED_VTOP_TCP_TX_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_TCP_tx final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtop_TCP_tx(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_TCP_tx();
    VL_UNCOPYABLE(Vtop_TCP_tx);
