...
void Vpayload_FIFO___024root__trace_chg_0_sub_0(Vpayload_FIFO___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+67,(vlSelfRef.TCP_flush));
    bufp->chgBit(oldp+68,(vlSelfRef.axis_t_last));
    bufp->chgQData(oldp+69,(vlSelfRef.axis_data_rx),64);
    bufp->chgBit(oldp+71,(vlSelfRef.handshake_done));
    bufp->chgIData(oldp+72,(vlSelfRef.seq_rcv_start),32);
    bufp->chgBit(oldp+73,(vlSelfRef.wr_FIFO_en));
    ...
    bufp->chgBit(oldp+77,(vlSelfRef.rd_FIFO_valid));
    bufp->chgCData(oldp+78,(vlSelfRef.rd_FIFO_ptr),3);
    bufp->chgCData(oldp+79,(vlSelfRef.rd_FIFO_len),3);
    bufp->chgBit(oldp+80,(vlSelfRef.rd_FIFO_en));
    bufp->chgIData(oldp+81,(vlSelfRef.seq_rx_FIFO_rd),32);
    bufp->chgBit(oldp+82,(vlSelfRef.full));
    bufp->chgBit(oldp+83,(vlSelfRef.axis_r_en));
    bufp->chgBit(oldp+84,(vlSelfRef.axis_r_valid));
    bufp->chgQData(oldp+85,(vlSelfRef.axis_rd_data),64);
    bufp->chgCData(oldp+87,((0xfU & ((1U & ((IData)(vlSelfRef.wr_FIFO_offset) 
                                            >> 7U)) 
