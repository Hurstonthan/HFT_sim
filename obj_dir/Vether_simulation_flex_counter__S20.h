...
#ifndef VERILATED_VETHER_SIMULATION_FLEX_COUNTER__S20_H_
#define VERILATED_VETHER_SIMULATION_FLEX_COUNTER__S20_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vether_simulation_flex_counter__S20 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vether_simulation_flex_counter__S20(Vether_simulation__Syms* symsp, const char* v__name);
    ~Vether_simulation_flex_counter__S20();
    VL_UNCOPYABLE(Vether_simulation_flex_counter__S20);
