...
#ifndef VERILATED_VTOP_TCP__F10_H_
#define VERILATED_VTOP_TCP__F10_H_  // guard
...
class Vtop_flex_counter__S20;


class Vtop__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vtop_TCP__F10 final : public VerilatedModule {
  public:
    // CELLS
    ...
    Vtop_flex_counter__S20* __PVT__timeout_fl;
    ...
    // CONSTRUCTORS
    Vtop_TCP__F10(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_TCP__F10();
    VL_UNCOPYABLE(Vtop_TCP__F10);
