...
VL_ATTR_COLD void Vethernet_rx_priority_encoder__W8_Mz1___stl_sequent__TOP__ethernet_rx__mac_inst__crc_check_encoder__0(Vethernet_rx_priority_encoder__W8_Mz1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vethernet_rx_priority_encoder__W8_Mz1___stl_sequent__TOP__ethernet_rx__mac_inst__crc_check_encoder__0\n"); );
...
VL_ATTR_COLD void Vethernet_rx_priority_encoder__W8_Mz1___ctor_var_reset(Vethernet_rx_priority_encoder__W8_Mz1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vethernet_rx_priority_encoder__W8_Mz1___ctor_var_reset\n"); );
    Vethernet_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
