...
#ifndef VERILATED_VETHER_SIMULATION_TOP__CBZ1_H_
#define VERILATED_VETHER_SIMULATION_TOP__CBZ1_H_  // guard
...
class Vether_simulation_TCP__F10_CBz1;
class Vether_simulation_payload_FIFO;


class Vether_simulation__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vether_simulation_top__CBz1 final : public VerilatedModule {
  public:
    // CELLS
    ...
    Vether_simulation_TCP__F10_CBz1* __PVT__u_tcp;
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__protocol_data_flag;
    ...
    // CONSTRUCTORS
    Vether_simulation_top__CBz1(Vether_simulation__Syms* symsp, const char* v__name);
    ~Vether_simulation_top__CBz1();
    VL_UNCOPYABLE(Vether_simulation_top__CBz1);
