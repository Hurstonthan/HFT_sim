...
#include "Vether_simulation_TCP_ISN__Cz2.h"
...
class alignas(VL_CACHE_LINE_BYTES)Vether_simulation__Syms final : public VerilatedSyms {
  public:
    ...
    Vether_simulation_priority_encoder__W8_Mz2 TOP__ether_simulation__clt_inst__mac_rx__crc_check_encoder;
    ...
    Vether_simulation_priority_encoder__W10_Mz2 TOP__ether_simulation__clt_inst__mac_rx__xgmii_fcs;
    ...
    Vether_simulation_TCP__F10_CBz2 TOP__ether_simulation__clt_inst__u_tcp;
    Vether_simulation_TCP_ISN__Cz2 TOP__ether_simulation__clt_inst__u_tcp__ISN_gen;
    ...
    Vether_simulation_flex_counter__S9 TOP__ether_simulation__clt_inst__u_tcp__tcp_flow__timewait;
    ...
    Vether_simulation_top__CBz1    TOP__ether_simulation__svr_inst;
    ...
    Vether_simulation_priority_encoder__W8_Mz2 TOP__ether_simulation__svr_inst__mac_rx__crc_check_encoder;
    ...
    Vether_simulation_priority_encoder__W10_Mz2 TOP__ether_simulation__svr_inst__mac_rx__xgmii_fcs;
    ...
    Vether_simulation_TCP__F10_CBz1 TOP__ether_simulation__svr_inst__u_tcp;
    Vether_simulation_TCP_ISN__Cz1 TOP__ether_simulation__svr_inst__u_tcp__ISN_gen;
    ...
    Vether_simulation_flex_counter__S9 TOP__ether_simulation__svr_inst__u_tcp__tcp_flow__timewait;
