...
VL_ATTR_COLD void VMAC_rx_MAC_rx___eval_initial__TOP__MAC_rx(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___eval_initial__TOP__MAC_rx\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSymsp->TOP__MAC_rx__CRC.__PVT__rx = 0U;
}

VL_ATTR_COLD void VMAC_rx_MAC_rx___stl_sequent__TOP__MAC_rx__0(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___stl_sequent__TOP__MAC_rx__0\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VMAC_rx_MAC_rx___stl_sequent__TOP__MAC_rx__2(VMAC_rx_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMAC_rx_MAC_rx___stl_sequent__TOP__MAC_rx__2\n"); );
    VMAC_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
