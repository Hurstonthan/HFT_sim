...
VL_ATTR_COLD void VTCP___024root___eval_static(VTCP___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP___024root___eval_static\n"); );
...
VL_ATTR_COLD void VTCP___024root___eval_initial(VTCP___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP___024root___eval_initial\n"); );
    VTCP__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

VL_ATTR_COLD void VTCP___024root___eval_final(VTCP___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP___024root___eval_final\n"); );
    VTCP__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void VTCP___024root___dump_triggers__stl(VTCP___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool VTCP___024root___eval_phase__stl(VTCP___024root* vlSelf);

VL_ATTR_COLD void VTCP___024root___eval_settle(VTCP___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP___024root___eval_settle\n"); );
    VTCP__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#ifdef VL_DEBUG
            VTCP___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("rtl/TCP.sv", 4, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (VTCP___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
#ifdef VL_DEBUG
VL_ATTR_COLD void VTCP___024root___dump_triggers__stl(VTCP___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP___024root___dump_triggers__stl\n"); );
    VTCP__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VTCP___024root___stl_sequent__TOP__0(VTCP___024root* vlSelf);
...
VL_ATTR_COLD void VTCP___024root___eval_stl(VTCP___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP___024root___eval_stl\n"); );
    VTCP__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VTCP___024root___stl_sequent__TOP__0(vlSelf);
        VTCP___024root____Vm_traceActivitySetAll(vlSelf);
    }
}

VL_ATTR_COLD void VTCP___024root___stl_sequent__TOP__0(VTCP___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTCP___024root___stl_sequent__TOP__0\n"); );
    VTCP__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
