...
VL_ATTR_COLD void Vether_simulation_TCP__F10_CBz2___ctor_var_reset(Vether_simulation_TCP__F10_CBz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_TCP__F10_CBz2___ctor_var_reset\n"); );
