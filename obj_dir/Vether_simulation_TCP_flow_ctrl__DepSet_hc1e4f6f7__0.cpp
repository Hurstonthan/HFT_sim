...
VL_INLINE_OPT void Vether_simulation_TCP_flow_ctrl___nba_sequent__TOP__ether_simulation__svr_inst__u_tcp__tcp_flow__0(Vether_simulation_TCP_flow_ctrl* vlSelf) {
    ...
    vlSelfRef.__Vdly__pass_close = vlSelfRef.__PVT__pass_close;
    ...
    if (vlSelfRef.__PVT__nRST) {
        ...
        vlSelfRef.__Vdly__pass_close = vlSelfRef.__PVT__npass_close;
        ...
        vlSelfRef.__Vdly__rcv_next = (((IData)(vlSelfRef.__PVT__nw_segment) 
                                       | (IData)(vlSelfRef.__PVT__rcv_data))
                                       ? vlSelfRef.__PVT__nrcv_next
                                       : ((IData)(vlSelfRef.__PVT__match_found)
                                           ? VL_SEL_IWII(97, 
        ...
        vlSelfRef.__Vdly__pass_close = 0U;
    }
    vlSelfRef.__PVT__pass_close = vlSelfRef.__Vdly__pass_close;
