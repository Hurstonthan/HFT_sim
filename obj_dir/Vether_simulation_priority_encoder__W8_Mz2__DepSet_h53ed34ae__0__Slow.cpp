...
VL_ATTR_COLD void Vether_simulation_priority_encoder__W8_Mz2___stl_sequent__TOP__ether_simulation__svr_inst__mac_rx__crc_check_encoder__0(Vether_simulation_priority_encoder__W8_Mz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vether_simulation_priority_encoder__W8_Mz2___stl_sequent__TOP__ether_simulation__svr_inst__mac_rx__crc_check_encoder__0\n"); );
...
VL_ATTR_COLD void Vether_simulation_priority_encoder__W8_Mz2___stl_sequent__TOP__ether_simulation__clt_inst__mac_rx__crc_check_encoder__0(Vether_simulation_priority_encoder__W8_Mz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vether_simulation_priority_encoder__W8_Mz2___stl_sequent__TOP__ether_simulation__clt_inst__mac_rx__crc_check_encoder__0\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__valid = 0U;
...
VL_ATTR_COLD void Vether_simulation_priority_encoder__W8_Mz2___ctor_var_reset(Vether_simulation_priority_encoder__W8_Mz2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vether_simulation_priority_encoder__W8_Mz2___ctor_var_reset\n"); );
    Vether_simulation__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
