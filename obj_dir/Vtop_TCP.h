...
#ifndef VERILATED_VTOP_TCP_H_
#define VERILATED_VTOP_TCP_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_TCP final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vtop_TCP(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_TCP();
    VL_UNCOPYABLE(Vtop_TCP);
