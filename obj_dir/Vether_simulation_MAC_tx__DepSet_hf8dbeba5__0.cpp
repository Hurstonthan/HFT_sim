...
VL_INLINE_OPT void Vether_simulation_MAC_tx___nba_sequent__TOP__ether_simulation__svr_inst__mac_tx__1(Vether_simulation_MAC_tx* vlSelf) {
    ...
    vlSelfRef.__Vdly__IP_last_dl = vlSelfRef.__PVT__IP_last_dl;
    ...
    if (vlSelfRef.__PVT__nRST) {
        ...
        vlSelfRef.__Vdly__IP_last_dl = vlSelfRef.__PVT__IP_last;
    } else {
        ...
        vlSelfRef.__Vdly__IP_last_dl = 0U;
    }
    ...
    vlSelfRef.__PVT__IP_last_dl = vlSelfRef.__Vdly__IP_last_dl;
