...
VL_ATTR_COLD void Vether_simulation_top__CBz1___ctor_var_reset(Vether_simulation_top__CBz1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vether_simulation_top__CBz1___ctor_var_reset\n"); );
