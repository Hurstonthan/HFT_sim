...
VL_INLINE_OPT void Vethernet_rx_priority_encoder__W10_Mz1___ico_sequent__TOP__ethernet_rx__mac_inst__xgmii_fcs__0(Vethernet_rx_priority_encoder__W10_Mz1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vethernet_rx_priority_encoder__W10_Mz1___ico_sequent__TOP__ethernet_rx__mac_inst__xgmii_fcs__0\n"); );
...
VL_INLINE_OPT void Vethernet_rx_priority_encoder__W10_Mz1___nba_sequent__TOP__ethernet_rx__mac_inst__xgmii_fcs__0(Vethernet_rx_priority_encoder__W10_Mz1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vethernet_rx_priority_encoder__W10_Mz1___nba_sequent__TOP__ethernet_rx__mac_inst__xgmii_fcs__0\n"); );
    Vethernet_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__valid = 0U;
