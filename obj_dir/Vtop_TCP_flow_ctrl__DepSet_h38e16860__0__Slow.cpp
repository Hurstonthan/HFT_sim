...
VL_ATTR_COLD void Vtop_TCP_flow_ctrl___stl_sequent__TOP__top__u_tcp__tcp_flow__0(Vtop_TCP_flow_ctrl* vlSelf) {
    ...
    vlSymsp->TOP__top__u_tcp__tcp_flow__lt.__PVT__din 
        = vlSelfRef.__PVT__left_trim_mask;
    vlSymsp->TOP__top__u_tcp__tcp_flow__rt.__PVT__din 
        = vlSelfRef.__PVT__right_trim_mask;
    vlSymsp->TOP__top__u_tcp__tcp_flow__ov.__PVT__din 
        = vlSelfRef.__PVT__overlap_mask;
...
VL_ATTR_COLD void Vtop_TCP_flow_ctrl___stl_sequent__TOP__top__u_tcp__tcp_flow__1(Vtop_TCP_flow_ctrl* vlSelf) {
    ...
    vlSelfRef.__PVT__lt_idx = vlSymsp->TOP__top__u_tcp__tcp_flow__lt.__PVT__idx;
    vlSelfRef.__PVT__rt_idx = vlSymsp->TOP__top__u_tcp__tcp_flow__rt.__PVT__idx;
    vlSelfRef.__PVT__rt_idx = vlSymsp->TOP__top__u_tcp__tcp_flow__ov.__PVT__idx;
