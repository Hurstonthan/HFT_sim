...
void VMAC_rx___024root__trace_chg_0_sub_0(VMAC_rx___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[5U]))) {
        ...
        bufp->chgIData(oldp+91,(vlSymsp->TOP__MAC_rx.__PVT__rg),32);
        bufp->chgQData(oldp+92,(vlSymsp->TOP__MAC_rx.__PVT__FCS_frame_cvt),64);
        bufp->chgBit(oldp+94,(vlSymsp->TOP__MAC_rx.__PVT__crc_delay));
        bufp->chgBit(oldp+95,(vlSymsp->TOP__MAC_rx.__PVT__soft_dl));
        bufp->chgQData(oldp+96,(vlSymsp->TOP__MAC_rx.__PVT__MAC_payload_rcv_cvrt),64);
        bufp->chgCData(oldp+98,(vlSymsp->TOP__MAC_rx.__PVT__bytes_rcv),8);
        bufp->chgCData(oldp+99,(vlSymsp->TOP__MAC_rx.__PVT__bytes_rcv_dl),8);
        bufp->chgCData(oldp+100,(vlSymsp->TOP__MAC_rx.__PVT__state),6);
        bufp->chgQData(oldp+101,(vlSymsp->TOP__MAC_rx__crc_frame_convert.__PVT__xgmii_rxd),64);
