...
VL_ATTR_COLD void Vether_simulation_MAC_rx___ctor_var_reset(Vether_simulation_MAC_rx* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vether_simulation_MAC_rx___ctor_var_reset\n"); );
    ...
    vlSelf->__PVT__ncrc_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5034100552395133719ull);
    vlSelf->__PVT__i = 0;
    ...
    vlSelf->__Vdly__crc_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5336787883486634921ull);
}
