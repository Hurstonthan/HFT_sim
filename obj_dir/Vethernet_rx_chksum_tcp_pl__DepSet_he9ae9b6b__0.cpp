...
VL_INLINE_OPT void Vethernet_rx_chksum_tcp_pl___nba_sequent__TOP__ethernet_rx__ip_inst__chksum_inst__0(Vethernet_rx_chksum_tcp_pl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vethernet_rx_chksum_tcp_pl___nba_sequent__TOP__ethernet_rx__ip_inst__chksum_inst__0\n"); );
...
VL_INLINE_OPT void Vethernet_rx_chksum_tcp_pl___nba_comb__TOP__ethernet_rx__ip_inst__chksum_inst__0(Vethernet_rx_chksum_tcp_pl* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vethernet_rx_chksum_tcp_pl___nba_comb__TOP__ethernet_rx__ip_inst__chksum_inst__0\n"); );
    Vethernet_rx__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
