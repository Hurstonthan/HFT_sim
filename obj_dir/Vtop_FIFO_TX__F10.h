...
#ifndef VERILATED_VTOP_FIFO_TX__F10_H_
#define VERILATED_VTOP_FIFO_TX__F10_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_FIFO_TX__F10 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtop_FIFO_TX__F10(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_FIFO_TX__F10();
    VL_UNCOPYABLE(Vtop_FIFO_TX__F10);
