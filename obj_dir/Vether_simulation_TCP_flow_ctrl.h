...
#include "verilated.h"
class Vether_simulation_flex_counter__S9;
...
class alignas(VL_CACHE_LINE_BYTES) Vether_simulation_TCP_flow_ctrl final : public VerilatedModule {
  public:
    // CELLS
    Vether_simulation_flex_counter__S9* __PVT__timewait;
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__timewait_en;
        CData/*0:0*/ __PVT__timewait_clear;
        CData/*0:0*/ __PVT__timewait_flag;
        CData/*0:0*/ __PVT__pass_close;
        CData/*0:0*/ __PVT__npass_close;
    ...
    struct {
        ...
        CData/*3:0*/ __Vlvbound_h99f49f73__0;
        CData/*3:0*/ __Vlvbound_h8a344adc__0;
