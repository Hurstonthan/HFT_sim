...
void reset_dut(VIP_rx *top, VerilatedFstC *tfp) {
    top->nRST = 0;
    top->MAC_valid = 0;
...
void send_ip_packet(VIP_rx *top, VerilatedFstC *tfp, 
...
int main(int argc, char **argv) {
    ...
    uint64_t header0 = (0x112233445566ULL << 16) | 0x0800; // MAC src, IP type
    ...
    uint64_t header3 = (IP_DEST_ADDR & 0xFFFF) << 48;
    ...
    header0 = (0x112233445566ULL << 16) | 0x0800; // MAC src, IP type
    ...
    send_ip_packet(top, tfp, header0, header1, header2, header3, icmp_payload);
