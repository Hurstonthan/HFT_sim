module mold_counter #(
    parameter SEL_1 = 8'b00111111, //for difference = 0
    parameter SEL_2 = 8'b10000000 // difference = 0
    )(
        input logic clk,
        input logic n_rst,
        ...
        if (mold_valid) begin
            casez(difference)
                16'd0: begin
                    ...
                    byte_done = 1'b1;
                    next_segment_sel[~sel] = SEL_1;
                    next_expected_message_len = mold_payload[63:48];
                end
                16'd1: begin
                    next_byte_count = 16'd5;
                    byte_done = 1'b1;
                    next_segment_sel[~sel] = SEL_1 >> difference;
                    next_segment_sel[sel] = SEL_2;
                ...
                16'd2: begin 
                    ...
                    byte_done = 1'b1;
                    next_segment_sel[~sel] = SEL_1 >> difference;
                    next_segment_sel[sel] = $signed(SEL_2) >> 1;
                ...
                16'd3: begin
                    ...
                    byte_done = 1'b1;
                    next_segment_sel[~sel] = SEL_1 >> difference;
                    next_segment_sel[sel] = $signed(SEL_2) >> 2;
                ...
                16'd4: begin
                    ...
                    byte_done = 1'b1;
                    next_segment_sel[~sel] = SEL_1 >> difference;
                    next_segment_sel[sel] = $signed(SEL_2) >> 3;
