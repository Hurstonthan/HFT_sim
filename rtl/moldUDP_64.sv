...
>>>>>>> cb7102aeb5d460982c2a9d59fec79e15f002c5c5
...
>>>>>>> cb7102aeb5d460982c2a9d59fec79e15f002c5c5
        ...
        if (curr_state == CHKSUM) begin
            checksum = UDP_payload[15:0];
            session[79:32] = UDP_payload[63:16];
        end else if (curr_state == SESSION) begin
        ...
        end else if (curr_state == PAYLOAD && message_length != heartbeat && message_length != end_session) begin 
            mold_payload = UDP_payload;	
        end else if (curr_state == REREQ1) begin
	    request_session[79:16] = session[79:16]; 
        end else if (curr_state == REREQ2) begin
	    request_session[15:0] = session[15:0];
	    request_sequence_num[63:16] = sequence_num[63:16]; 
        end else if (curr_state == REREQ3) begin
